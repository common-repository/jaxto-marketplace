...
* to 'plugins/wordpress-jaxto-store/hybridauth/Hybrid/Providers/XING.php' and then add it to 
* $JAXTO_PROVIDERS_CONFIG :
*
*   ARRAY( 
...
*      'default_network'     : If true, it will shows up by default on Admin > JAXTO > Networks
...
* configuration pages (wp-admin/options-general.php?page=wordpress-jaxto-store).
*/
